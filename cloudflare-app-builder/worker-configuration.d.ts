/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: ca93b4528a5dee5d2fd602004e594a9c)
// Runtime types generated with workerd@1.20251011.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'GitRepositoryDO' | 'PreviewDO' | 'Sandbox';
  }
  interface Env {
    ...
    DEV_MODE: string;
    DB_PROXY_URL: string;
    GIT_REPOSITORY: DurableObjectNamespace<import('./src/index').GitRepositoryDO>;
    PREVIEW: DurableObjectNamespace<import('./src/index').PreviewDO>;
    SANDBOX: DurableObjectNamespace<import('./src/index').Sandbox>;
    TEMPLATES: R2Bucket;
    DB_PROXY: Service /* entrypoint AdminRPCEntrypoint from db-proxy */;
  }
}
