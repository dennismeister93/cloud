...
CREATE INDEX "IDX_app_builder_project_sessions_cloud_agent_session_id" ON "app_builder_project_sessions" USING btree ("cloud_agent_session_id");--> statement-breakpoint
