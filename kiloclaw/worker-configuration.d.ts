/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e65e0dfc099fd3d087fee2edb7fdec8b)
// Runtime types generated with workerd@1.20260128.0 2025-05-06 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'KiloClawSandbox' | 'KiloClawInstance';
  }
  interface Env {
    KILOCLAW_BUCKET: R2Bucket;
    HYPERDRIVE: Hyperdrive;
    Sandbox: DurableObjectNamespace<import('./src/index').KiloClawSandbox>;
